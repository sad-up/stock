...
import com.hh.stock.config.security.exception.CustomerAuthenticationException;
...
/**
 * @author : hh
 * @date : 2023/1/22 19:05
 * @description : 登录失败处理器类
 */
@Component
public class LoginFailureHandler implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request,
        ...
        //将错误信息转换成JSON
        String result =
                JSON.toJSONString(R.error(code, message));
